                ...
                <tbody1>
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-primary btn-lg"
                                href="user-edit.php?id=<?php echo $a; ?>&fullname=<?php echo $b; ?>&username=<?php echo $c; ?>&email=<?php echo $d; ?>&phone_number=<?php echo $e; ?>&dob=<?php echo $f; ?>&occupation=<?php echo $g; ?>&country=<?php echo $h; ?>&gender=<?php echo $i; ?>">Edit</a>
                        </td>
