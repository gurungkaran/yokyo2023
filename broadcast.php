...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-14" style="margin-left: 250px; margin-top: -150px;">
                <?php
            $dir = glob('assets/video/1/{*.mp4}', GLOB_BRACE);
            foreach ($dir as $value) {
            ?>
                <h3
                    style="color: black; font-size: 22px; margin-right: 50px; margin-top: 100px; margin-bottom: 15px; font-family: Arial, sans-serif;">
                    Neymar penalty seals gold for hosts - Yokyo 2023 FunOlympic Games</h3>
                <h3 style="font-size: 15px; font-family: Arial, sans-serif;">Live 🔴</h3>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-14" style="margin-left: 250px; margin-top: -150px;">
                <?php
            $dir = glob('assets/video/2/{*.mp4}', GLOB_BRACE);
            foreach ($dir as $value) {
            ?>
                <h3
                    style="color: black; font-size: 22px; margin-right: 50px; margin-top: 100px; margin-bottom: 15px; font-family: Arial, sans-serif;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-14" style="margin-left: 250px; margin-top: -150px;">
                <?php
        $dir = glob('assets/video/3/{*.mp4}', GLOB_BRACE);
        foreach ($dir as $value) {
        ?>
                <h3
                    style="color: black; font-size: 22px; margin-right: 50px; margin-top: 100px; margin-bottom: 15px; font-family: Arial, sans-serif;">
                    Nepal 0-2 India _ Live_Game_Yokyo FunOympic 2023</h3>
                <h3 style="font-size: 15px; font-family: Arial, sans-serif;">Live 🔴</h3>
                <div class="livebox" style="background-color: #fff;">
                    <a href="<?php echo $value; ?>">
                        <video src="<?php echo $value; ?>" alt="HNP" width="70%" ; controls>
    ...
    <div class="container">
        ...
        ?>
                <h3
                    style="color: black; font-size: 22px; margin-right: 50px; margin-top: 100px; margin-bottom: 15px; font-family: Arial, sans-serif;">
                   (Live Game) Omanyala dominates the men's 100m _ Continental Tour Gold 2023</h3>
                <h3 style="font-size: 15px; font-family: Arial, sans-serif;">Live 🔴</h3>
                <div class="livebox" style="background-color: #fff;">
                    <a href="<?php echo $value; ?>">
                        <video src="<?php echo $value; ?>" alt="HNP" width="70%" ; controls>
...
?>
        ...
        <div class="container">
            <div class="row" style="margin: 40px 0px; margin-top: -20px;">
                ...
                <div class="col-sm-6">
                    <div class="actions">
                        <a href="edit_comment.php?id=<?php echo $comment_id; ?>" class="edit">Edit</a>
                        <a href="delete_comment.php?id=<?php echo $comment_id; ?>" class="delete">Delete</a>
                    </div>
                </div>
            </div>
        </div>
